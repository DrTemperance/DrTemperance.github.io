...
!function (a,b) {
  ...
  n.fn = n.prototype = {
    ...
    for ('boolean'== typeof g && (j = g, g = arguments[h] || {}, h++), 'object'== typeof g || n.isFunction(g) || (g = {}), h===
                                                                                                                           i &&
                                                                                                                           (g
                                                                                                                              = this, h--);
         i>h;
    ...
    return g
                ...
                globalEval   : function (a) {
                  var b,c = eval;
                  a = n.trim(a), a &&
                                 (1===a.indexOf('use strict') ? (b = l.createElement('script'), b.text = a, l.head.appendChild(b)
                                                                                                             .parentNode
                                                                                                             .removeChild(b)) : c(
                                    a))
                },
                ...
                each         : function (a,b,c) {
                  ...
                  if (c) {
                    if (g) {for (; f>e; e++) if (d = b.apply(a[e],c), d=== !1) break} else {
                      for (e in a) {
                        if (d
                           = b.apply(a[e],c), d=== !1) {
                          break
                  ...
                  } else if (g) {for (; f>e; e++) if (d = b.call(a[e],e,a[e]), d=== !1) break} else {
                    for (e in a) {
                      if (d
                         = b.call(a[e],e,a[e]), d=== !1) {
                        break;
                      }
                    }
                  }
                ...
                proxy        : function (a,b) {
                  ...
                  return 'string'== typeof b && (c = a[b], b = a, a = c), n.isFunction(a)
                        ...
                        = function () {return a.apply(b || this,e.concat(d.call(arguments)))}, f.guid = a.guid = a.guid ||
                                                                                                                 n.guid++, f)
                                                                          : void 0
                },
                now          : Date.now,
  ...
  function s(a) {
    ...
    return 'function'===c || n.isWindow(a) ? !1 : 1===a.nodeType && b ? !0 : 'array'===
                                                                             c ||
                                                                             0===
                                                                             b ||
                                                                             'number'==
  ...
  var t = function (a) {
      ...
      if (p && !e) {
        ...
        if (c.qsa && (!q || !q.test(a))) {
          if (s = r = u, w = b, x = 9===k && a, 1===k && 'object'!==b.nodeName.toLowerCase()) {
            o
               = g(a), (r = b.getAttribute('id')) ? s = r.replace(bb,'\\$&') : b.setAttribute('id',s), s = '[id=\'' +
                                                                                                           s +
                                                                                                           '\'] ', l
               = o.length;
    ...
    c = fb.support = {}, f = fb.isXML = function (a) {
      ...
      return e!==n && 9===e.nodeType && e.documentElement ? (n = e, o = e.documentElement, p = !f(e), g &&
         ...
         function (a) {return a.className = 'i', !a.getAttribute('className')}), c.getElementsByTagName
        ...
        return f
                        ...
                        function (a,b) {return typeof b.getElementsByClassName!==C && p ? b.getElementsByClassName(a) : void 0}, r
         = [], q = [], (c.qsa = $.test(e.querySelectorAll)) &&
                       (ib(function (a) {
                         a.innerHTML
         ...
         = q.length && new RegExp(q.join('|')), r = r.length && new RegExp(r.join('|')), b = $.test(o.compareDocumentPosition), t
    ...
    }, fb.contains = function (a,b) {return (a.ownerDocument || a)!==n && m(a), t(a,b)}, fb.attr = function (
       a,
       b) {
      (a.ownerDocument ||
       a)!==n && m(a);
    ...
    }, fb.error = function (a) {throw new Error('Syntax error, unrecognized expression: ' + a)}, fb.uniqueSort
       = function (a) {
      var b,d = [],e = 0,f = 0;
      ...
      preFilter   : {
        ATTR  : function (a) {
          return a[1] = a[1].replace(cb,db), a[3] = (a[3] || a[4] || a[5] || '').replace(
             cb,
             db,
      ...
      filter      : {
        TAG     : function (a) {
          ...
          return e[u] ? e(b) : e.length>1 ? (c = [a,a,'',b], d.setFilters.hasOwnProperty(a.toLowerCase()) ? hb(function (
             a,
             c) {
            var d,
                f = e(
    ...
    return h = fb.compile = function (a,b) {
      ...
      if (e = e || [], 1===o.length) {
        if (j = o[0] = o[0].slice(0), j.length>
                                      ...
                                      d.relative[j[1].type]) {
          if (b
             = (d.find.ID(k.matches[0].replace(cb,db),b) || [])[0], !b) {
            return e;
          }
  ...
  var y,z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,A = n.fn.init = function (a,b) {
    ...
    if ('string'== typeof a) {
      ...
      if (c[1]) {
        if (b = b instanceof n ? b[0] : b, n.merge(
           this,
    ...
    return a.nodeType ? (this.context = this[0] = a, this.length = 1, this) : n.isFunction(a) ? 'undefined'!= typeof y.ready
                                                                                                ? y.ready(a)
                                                                                                : a(n) : (void 0!==
                                                                                                          a.selector &&
                                                                                                          (this.selector
                                                                                                             = a.selector, this.context
                                                                                                             = a.context), n.makeArray(
       a,
       this,
    ))
  };
        ...
        k = {
          ...
          fireWith: function (a,b) {
            return !h ||
                   c &&
                   !i ||
                   (b = b || [], b = [a,b.slice ? b.slice() : b], d ? i.push(b) : j(b)), this
          },
                ...
                Deferred: function (a) {
                  ...
                  return d.pipe = d.then, n.each(b,function (a,f) {
                    ...
                    d[f[1]] = g.add, h && g.add(function () {c = h},b[1 ^ a][2].disable,b[2][2].lock), e[f[0]]
                       = function () {return e[f[0] + 'With'](this===e ? d : this,arguments), this}, e[f[0] + 'With'] = g.fireWith
  ...
  n.ready.promise = function (b) {
    return H ||
           (H = n.Deferred(), 'complete'===l.readyState ? setTimeout(n.ready) : (l.addEventListener(
              'DOMContentLoaded',
              I,
              !1,
  ...
  n.event = {
    ...
    trigger   : function (b,c,d,e) {
      ...
      if (g = h = d = d || l, 3!==
                              ...
                              0 &&
                              'on' +
                              q, b = b[n.expando] ? b : new n.Event(q,'object'== typeof b && b), b.isTrigger = e
                                                                                                               ? 2
                                                                                                               : 3, b.namespace
                                 = r.join('.'), b.namespace_re = b.namespace ? new RegExp('(^|\\.)' +
                                                                                          r.join('\\.(?:.*\\.|)') +
                                                                                          '(\\.|$)') : null, b.result
        ...
        if (!e &&
          ...
          for (i
                  = o.delegateType ||
                    q, X.test(i + q) || (g = g.parentNode); g; g = g.parentNode) {
            p.push(g), h = g;
          }
          ...
          if (i.disabled!==
            ...
            for (d
              ...
              f = b[c], e = f.selector + ' ', void 0===
                                              d[e] &&
                                              (d[e] = f.needsContext ? n(e,this).index(i)>=0 : n.find(
                                                 e,
                                                 this,
                                                 null,
                                                 [i],
    ...
    fix       : function (a) {
      ...
      g || (this.fixHooks[e] = g = W.test(e) ? this.mouseHooks : V.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(
         g.props) : this.props, a = new n.Event(f), b = d.length;
  ...
  }, n.removeEvent = function (a,b,c) {a.removeEventListener && a.removeEventListener(b,c,!1)}, n.Event = function (
     a,
     b) {
              ...
              e ? L.access(d,b,e) : (d.removeEventListener(a,c,!0), L.remove(d,b))
                      ...
                      on            : function (a,b,c,d,e) {
                        ...
                        if (null==c && null==d ? (d = b, c = b = void 0) : null==
                                                                           d &&
                                                                           ('string'== typeof b ? (d = c, c = void 0) : (d = c, c
                                                                              = b, b = void 0)), d=== !1) {
                          d
                             = $;
                        ...
                        return 1===
                               e &&
                               (f = d, d = function (a) {return n().off(a), f.apply(this,arguments)}, d.guid = f.guid ||
                                                                                                               (f.guid
                                                                                                                  = n.guid++)), this.each(
                 ...
                 if (e = a[m], e || 0===e) {
                   if ('object'===n.type(e)) {
                     ...
                     f = f || k.appendChild(b.createElement('div')), g = (bb.exec(e) ||
                                                                          ['',''])[1].toLowerCase(), h
                        = ib[g] || ib._default, f.innerHTML = h[1] + e.replace(ab,'<$1></$2>') + h[2], j = h[0];
                 ...
                 delete M.cache[c[M.expando]]
                             ...
                             replaceWith: function () {
                               ...
                               return this.domManip(
                                  arguments,
                                  function (b) {
                                    a = this.parentNode, n.cleanData(ob(this)), a &&
                                   ...
                                   for (i = f[f.length - 1].ownerDocument, n.map(f,lb), j = 0; g>j; j++) {
                                     h
                                        = f[j], fb.test(h.type || '') &&
                                                ...
                                                n.contains(i,h) &&
                                                (h.src ? n._evalUrl && n._evalUrl(h.src) : n.globalEval(h.textContent.replace(
                                                   hb,
                                                   '',
                                                )))
                                   }
  ...
  function tb(a) {
    ...
    return c ||
           ...
           c &&
           c ||
           (qb = (qb || n('<iframe frameborder=\'0\' width=\'0\' height=\'0\'/>')).appendTo(b.documentElement), b
              = qb[0].contentDocument, b.write(), b.close(), c = sb(a,b), qb.detach()), rb[a] = c), c
  }
  ...
  function xb(a,b,c) {
    ...
    return c = c || wb(a), c && (g = c.getPropertyValue(b) || c[b]), c &&
                                                                     ...
                                                                     (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth
                                                                        ...
                                                                        = d, h.minWidth = e, h.maxWidth = f)), void 0!==g
                                                                                                               ? g + ''
                                                                                                               : g
  }
         ...
         k,
         {
           ...
           reliableMarginRight: function () {
             ...
             return c.style.cssText = f.style.cssText
                ...
                = c.style.width = '0', f.style.width = '1px', d.appendChild(e), b = !parseFloat(a.getComputedStyle(
                c,
                null,
  ...
  n.extend({
                                                                                                                       ...
                                                                                                                       d,
                                                                                                                        ...
                                                                                                                        (e
                                                                                                                           = Db[b]), ''===
                                                                                                                                     ...
                                                                                                                                     c
                                                                                                                                     ? (f
                     = parseFloat(e), c=== !0 || n.isNumeric(f) ? f || 0 : e)
                                                                                                                                     : e
             },
           }), n.each(
     ['height','width'],
       ...
       n.cssHooks[b] = {
         get  : function (a,c,d) {
           return c ? zb.test(n.css(a,'display')) &&
                      0===
                      a.offsetWidth ? n.swap(a,Cb,function () {return Ib(a,b,d)}) : Ib(a,b,d) : void 0
         },set: function (a,c,d) {
           var e = d && wb(a);
     ...
     function (a,b) {return b ? n.swap(a,{display: 'inline-block'},xb,[a,'marginRight']) : void 0},
  ), n.each(
  ...
  n.Tween = Kb, Kb.prototype = {
    ...
    init       : function (a,b,c,d,e,f) {
      this.elem = a, this.prop = c, this.easing = e ||
                                                  'swing', this.options = b, this.start = this.now = this.cur(), this.end
  ...
  function Vb(a,b,c) {
         ...
         (o.display = 'inline-block')), c.overflow &&
                                        (o.overflow = 'hidden', l.always(function () {
                                          o.overflow = c.overflow[0], o.overflowX
                                             = c.overflow[1], o.overflowY = c.overflow[2]
                                        }));
    for (d in b) {
      if (e = b[d], Nb.exec(e)) {
    ...
    if (n.isEmptyObject(m)) {
      ...
      q ? 'hidden' in
         ...
         'fxshow',
         {},
      ), f && (q.hidden = !p), p ? n(a).show() : l.done(function () {n(a).hide()}), l.done(function () {
        var b;
        L.remove(a,'fxshow');
        for (b in m) n.style(a,b,m[b])
      });
      for (d in m) {
        g = Ub(p ? q[d] : 0,d,l), d in
                                  q ||
                                  (q[d] = g.start, p &&
  ...
  function Xb(a,b,c) {
    ...
    return n.map(k,Ub,j), n.isFunction(j.opts.start) && j.opts.start.call(a,j), n.fx.timer(n.extend(
       i,
       {
         elem : a,
         anim : j,
  ...
  n.Animation = n.extend(Xb,{
    ...
    return d.duration = n.fx.off ? 0 : 'number'== typeof d.duration ? d.duration : d.duration in n.fx.speeds
                                                                                   ...
                                                                                   : n.fx.speeds._default, (null==
                                                                                                            d.queue ||
                                                                                                            d.queue===
                                                                                                            !0) &&
                                                                                                           (d.queue = 'fx'), d.old
       = d.complete, d.complete = function () {n.isFunction(d.old) && d.old.call(this), d.queue && n.dequeue(this,d.queue)}, d
  }, n.fn.extend({
  ...
  }, n.fx.timer = function (a) {n.timers.push(a), a() ? n.fx.start() : n.timers.pop()}, n.fx.interval = 13, n.fx.start
     = function () {Mb || (Mb = setInterval(n.fx.tick,n.fx.interval))}, n.fx.stop = function () {
    clearInterval(Mb), Mb
       = null
  ...
  n.fn.extend({
                ...
                removeAttr: function (a) {return this.each(function () {n.removeAttr(this,a)})},
                             ...
                             attr      : function (a,b,c) {
                               ...
                               if (a && 3!==f && 8!==f && 2!==f) {
                                 return typeof a.getAttribute===U ? n.prop(a,b,c) : (1===
                                                                                     f &&
                                                                                     n.isXMLDoc(a) ||
                                                                                     (b
                                                                                        = b.toLowerCase(), d
                                                                                     ...
                                                                                     (n.expr.match.bool.test(
                                                                                      ...
                                                                                      : Yb)), void 0===
                                                                                              ...
                                                                                              ? d &&
                                                                                                ...
                                                                                                ? e
                                                                                                : (e
                                          = n.find.attr(a,b), null==e ? void 0 : e)
                                                                                              : null!==
                                                                                                c
                                                                                                ? d &&
                                                                                                  'set' in
                           ...
                           }), Zb = {set: function (a,b,c) {return b=== !1 ? n.removeAttr(a,c) : a.setAttribute(c,c), c}}, n.each(
  ...
  n.fn.extend({
                val: function (a) {
                  var b,c,d,e = this[0];
                  {
                    if (arguments.length) {
                      return d = n.isFunction(a), this.each(function (c) {
                        ...
                        (e = d ? a.call(this,c,n(this).val()) : a, null==e ? e = '' : 'number'== typeof e
                                                                                      ? e += ''
                                                                                      : n.isArray(e) &&
                        (e = n.map(e,function (a) {return null==a ? '' : a + ''})), b = n.valHooks[this.type] ||
                    ...
                    if (e) {
                      return b = n.valHooks[e.type] || n.valHooks[e.nodeName.toLowerCase()], b &&
                                                                                             'get' in
                                                                                             b &&
                                                                                             void 0!==
                                                                                             (c = b.get(e,'value')) ? c : (c
  ...
  n.extend({
             ...
             ajax         : function (a,b) {
               ...
               i = k.global, i && 0===n.active++ && n.event.trigger('ajaxStart'), k.type = k.type.toUpperCase(), k.hasContent
                  = !kc.test(k.type), d = k.url, k.hasContent ||
                                                 (k.data &&
               ...
               function x(a,b,f,h) {
                 ...
                 2!==
                 t &&
                 (t = 2, g && clearTimeout(g), c = void 0, e = h || '', v.readyState = a>0 ? 4 : 0, j = a>=
                                                                                                        200 &&
                                                                                                        300>
                                                                                                        a ||
                                                                                                        304===
                                                                                                        a, f && (u = uc(k,v,f)), u
                    = vc(k,u,v,j), j ? (k.ifModified &&
                 ...
                 (n.etag[d] = w)), 204===a || 'HEAD'===k.type ? x = 'nocontent' : 304===a ? x = 'notmodified' : (x = u.state, r
                    = u.data, s = u.error, j = !s)) : (s = x, (a || !x) && (x = 'error', 0>a && (a = 0))), v.status
                    = a, v.statusText = (b || x) + '', j ? o.resolveWith(l,[r,x,v]) : o.rejectWith(l,[v,x,s]), v.statusCode(q), q
                    = void 0, i && m.trigger(j ? 'ajaxSuccess' : 'ajaxError',[v,k,j ? r : s]), p.fireWith(l,[v,x]), i &&
     ...
     function (a,b) {
       n[b] = function (a,c,d,e) {
         return n.isFunction(c) &&
                (e = e || d, d = c, c = void 0), n.ajax({url: a,type: b,dataType: e,data: c,success: d})
       }
     },
  ), n.each(
    ...
    return n.ajax({
                   ...
                   wrapAll  : function (a) {
                     var b;
                     return n.isFunction(a) ? this.each(function (b) {n(this).wrapAll(a.call(this,b))}) : (this[0] &&
                                                                                                           (b = n(
                                                                                                              a,
  ...
  a.ActiveXObject && n(a).on('unload',function () {for (var a in Dc) Dc[a]()}), k.cors = !!Fc && 'withCredentials' in Fc, k.ajax
     = Fc = !!Fc, n.ajaxTransport(function (a) {
    var b;
    return k.cors || Fc && !a.crossDomain ? {
      send   : function (c,d) {
        ...
        b = function (a) {
          return function () {
            b &&
            (delete Dc[g], b = f.onload = f.onerror = null, 'abort'===a ? f.abort() : 'error'===
                                                                                      a
                                                                                      ? d(
                  f.status,
                  f.statusText,
    ...
    if (a.crossDomain) {
      ...
      return {
        send   : function (d,e) {
          ...
          .on(
             'load error',
             c = function (a) {b.remove(), c = null, a && e('error'===a.type ? 404 : 200,a.type)},
  ...
  n.ajaxSetup({
     ...
     function (b,c,d) {
       ...
       return h || 'jsonp'===b.dataTypes[0] ? (e = b.jsonpCallback = n.isFunction(b.jsonpCallback)
                                                                     ? b.jsonpCallback()
                                                                     : b.jsonpCallback, h ? b[h]
          = b[h].replace(Hc,'$1' + e) : b.jsonp!==
                                        !1 &&
                                        (b.url += (dc.test(b.url) ? '&' : '?') +
                                                  b.jsonp +
                                                  '=' +
          ...
          = 'json', f = a[e], a[e] = function () {g = arguments}, d.always(function () {
         a[e]
            = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Gc.push(e)), g &&
                                                                          n.isFunction(f) &&
                                                                          f(g[0]), g = f = void 0
       }), 'script') : void 0
     },
  ...
  n.offset = {
    setOffset: function (a,b,c) {
      ...
      'static'===k && (a.style.position = 'relative'), h = l.offset(), f = n.css(a,'top'), i = n.css(a,'left'), j = ('absolute'===
                                                                                                                     k ||
                                                                                                                     'fixed'===
                                                                                                                     k) &&
                                                                                                                    (f +
                                                                                                                     i).indexOf(
                                                                                                                       'auto')>
                                                                                                                    -1, j ? (d
         = l.position(), g = d.top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), n.isFunction(b) &&
                                                                                                    (b = b.call(a,c,h)), null!=
                                                                                                                         b.top &&
                                                                                                                         (m.top
                                                                                                                            = b.top -
            ...
            m)
                   ...
                   offset    : function (a) {
                     ...
                     if (f) {
                       return b = f.documentElement, n.contains(b,d) ? (typeof d.getBoundingClientRect!==
                                                                        U &&
    ...
    n.fn[b] = function (e) {
     ...
     function (a,b) {
       n.cssHooks[b] = yb(
          k.pixelPosition,
          function (a,c) {return c ? (c = xb(a,b), vb.test(c) ? n(a).position()[b] + 'px' : c) : void 0},
       )
     },
  ), n.each(
  ...
  return n.noConflict = function (b) {return a.$===n && (a.$ = Mc), b && a.jQuery===n && (a.jQuery = Lc), n}, typeof b===
                                                                                                              U &&
                                                                                                              (a.jQuery = a.$
                                                                                                                 = n), n
});
